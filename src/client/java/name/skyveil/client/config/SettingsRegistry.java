...
public final class SettingsRegistry {
    ...
    public static void registerDefaults(){
        ...
        ui.add("appearance","Appearance","Choose how Minecraft and Skyveil menus look and behave.")
        ...
        ui.add("storage_preview","Storage Preview","Configure the persistent Ender Chest and Backpack workspace.")
            ...
            .add(SettingDefinition.choice("general.storagePreviewTheme","Preview Color","Changes only the Storage Preview appearance.",List.of("Default","Dark","Dark Purple"),
        ...
        ui.add("item_rarity","Item Rarity","Control rarity-colored item slot backgrounds.")
        ...
        ui.add("chat_copy","Chat Copy","Copy the complete chat message under your cursor with one configurable chord.")
        ...
        ConfigCategory gameplay=register("gameplay","Gameplay","Combat readability, item protection, and menu shortcuts.");
        ...
        gameplay.add("item_protection","Item Protection","Prevent important inventory items from being moved or dropped.")
            .add(SettingDefinition.toggle("general.itemProtection.enabled","Enable Protection","Prevents locked items from being moved or dropped.",()->ConfigManager.get().itemProtection.enabled,v->ConfigManager.get().itemProtection.enabled=v))
        ...
        gameplay.add("bestiary","Bestiary","Control Bestiary-related chat presentation.")
        ...
        pets.add("pet_display","Pet Display","Customize the equipped-pet HUD and its information.")
            ...
            .add(SettingDefinition.slider("hud.petDisplay.scale","Display Scale","Uniformly scales the panel, text, icons, and progress bar.",.5,2,()->ConfigManager.get().petDisplay.scale,v->ConfigManager.get().petDisplay.scale=v))
